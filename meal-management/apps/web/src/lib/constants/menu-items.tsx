...
export const menuItems: MenuItem[] = [
    ...
    { key: 'meals', label: 'Quản lý bữa ăn', href: '/meals', icon: FoodTrayIcon, roles: ['ADMIN_KITCHEN', 'ADMIN_SYSTEM', 'CLERK'] },
    {
        key: 'config',
        label: 'Cấu hình hệ thống',
        href: '/config',
        icon: SettingsIcon,
        roles: ['ADMIN_SYSTEM', 'CLERK'],
        children: [
            { key: 'config-accounts', label: 'Cấp tài khoản', href: '/config/accounts', icon: IdCardIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-prices', label: 'Lịch sử giá', href: '/config/prices', icon: DollarIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-deadline', label: 'Giờ chốt', href: '/config/deadline', icon: ClockIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-ingredients', label: 'Danh mục nguyên liệu', href: '/config/ingredients', icon: PackageIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-menu-items', label: 'Danh mục món ăn', href: '/config/menu-items', icon: UtensilsIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-guests', label: 'Danh bạ khách', href: '/config/guests', icon: UsersIcon, roles: ['ADMIN_SYSTEM', 'CLERK'] },
            { key: 'config-departments', label: 'Phòng ban', href: '/config/departments', icon: BuildingIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-positions', label: 'Chức vụ', href: '/config/positions', icon: BriefcaseIcon, roles: ['ADMIN_SYSTEM'] },
            { key: 'config-locations', label: 'Địa điểm ăn', href: '/config/locations', icon: MapPinIcon, roles: ['ADMIN_SYSTEM'] },
        ]
    },
