                ...
                <div className="flex flex-col items-center justify-center py-4 lg:py-8">
                    <div className="w-full max-w-[440px] bg-white rounded-[32px] border border-slate-100 shadow-xl shadow-slate-200/50 overflow-hidden p-4 md:p-8 flex flex-col items-center">
                        ...
                        <div className="relative group w-full flex justify-center">
                            {/* Decorative frame */}
                            <div className="w-full max-w-[280px] aspect-square bg-slate-50 border-2 border-slate-100 rounded-[28px] flex items-center justify-center p-4 transition-all group-hover:border-blue-200 group-hover:bg-blue-50/30">
                        ...
                        <div className="w-full mt-10 p-6 bg-slate-50/80 rounded-[24px] border border-slate-100 space-y-4">
                            ...
                            <div className="relative group">
                                <input
                                    ...
                                    className="w-full h-12 pl-5 pr-12 bg-white border border-slate-200 rounded-xl text-lg font-bold text-slate-900 tracking-[0.3em] placeholder:tracking-normal placeholder:font-medium placeholder:text-slate-300 focus:outline-none focus:ring-4 focus:ring-blue-500/10 focus:border-blue-500 transition-all text-center"
                                    placeholder="••••••••"
                                />
                                <button
                            ...
                            <button
                                ...
                                className="w-full h-12 flex items-center justify-center gap-2 bg-blue-600 hover:bg-blue-700 disabled:bg-slate-200 disabled:text-slate-400 text-white font-bold rounded-xl transition-all shadow-lg shadow-blue-200 active:scale-[0.98]"
                            >
