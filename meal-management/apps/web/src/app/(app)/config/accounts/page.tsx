...
import { useDepartments } from '@/features/system';
...
export default function AccountManagementContent() {
    ...
    const filteredAccounts = accounts?.filter(acc => {
        ...
        const matchesDept = filterDept === 'all' || acc.department === filterDept;
                        ...
                        <table className="w-full text-left">
                            <thead>
                                <tr className="bg-slate-50/80 border-b border-slate-100">
                                    ...
                                    <th className="py-4 px-6 text-xs font-semibold text-slate-500 uppercase tracking-wider">Phòng ban</th>
