...
// Button states
type ButtonState = 'grayX' | 'greenUtensil' | 'redX' | 'blueCheck' | 'grayPlus' | 'blueCheckDisabled' | 'grayPlusDisabled';
...
const ActionButton = ({ state }: { state: ButtonState }) => {
    ...
    switch (state) {
        ...
        case 'blueCheckDisabled':
            return (
                <div className={`${baseClasses} bg-blue-300`}>
                    <CheckIcon className="w-5 h-5 text-white" />
                </div>
            );
        case 'grayPlus':
    ...
    return (
        <div className={cardClasses}>
            ...
            <div className="flex items-center gap-2">
                ...
                {isToday && (
                    <span className="bg-blue-500 text-white text-[10px] font-medium px-2 py-0.5 rounded">
                        TODAY
                    </span>
                )}
            </div>
        ...
        <div className="min-h-screen bg-gray-200 p-8">
            ...
            <div className="flex flex-wrap gap-6 mb-8">
                ...
                <Example caption="Ngày đã đăng ký ăn và đã bị khóa">
                    <DateCard
                        dayNumber={1}
                        leftButton="blueCheck"
                        rightButton="blueCheck"
                        isMuted
                    />
                </Example>
            ...
            <div className="flex flex-wrap gap-6">
                ...
                <Example caption="Today (chưa quá giờ chốt)">
                    <DateCard
                        ...
                        leftButton={todayActiveBeforeCutoff ? "blueCheck" : "blueCheckDisabled"}
                ...
                <Example caption="Today (quá giờ chốt)">
                    <DateCard
                        dayNumber={todayDateNumber}
                        leftButton={!todayActiveBeforeCutoff ? "blueCheckDisabled" : "blueCheck"}
